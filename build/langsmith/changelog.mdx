...
- [Experiment comparison](/langsmith/compare-experiment-results) now uses the v2 dataset example-runs endpoint and remembers Trace pane widths, so comparisons are more reliable and easier to revisit.
